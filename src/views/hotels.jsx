...
class Hotel extends Component {
    ...
    render() { 
                  ...
                  <div className="search_tabs d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-between justify-content-start">
                    <div className="search_tab active d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><a href="/hotels" alt><img src={suit} alt /><span>hotels</span></a></div>
                    ...
                    <div className="search_tab d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><a href="/flights" alt><img src={depart} alt />flights</a></div>
